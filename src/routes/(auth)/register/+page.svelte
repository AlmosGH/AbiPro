...
<main class="auth-page"><LanguagePicker /><section class="auth-card">
	<BrandMark size="large" /><span class="brand-name">AbiPro</span>
	{#if form?.checkEmail}
